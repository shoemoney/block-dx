  ...
  render(state) {
    ...
    const items = [
      ...
      },
      {
        ...
        text: Localize.text('Use this configure new local wallets for trading. Newly added wallets will need to be restarted before trading.','configurationWindowMenu'),
